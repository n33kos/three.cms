...
function createPage($mysqli){
    ...
    //$scriptIncludes =     filter_input(INPUT_POST, 'scriptIncludes', FILTER_SANITIZE_STRING);
    $scriptIncludes =     'test';
    $usePixelShaders =     filter_input(INPUT_POST, 'usePixelShaders', FILTER_SANITIZE_STRING);
    //$shaderIncludes =     filter_input(INPUT_POST, 'shaderIncludes', FILTER_SANITIZE_STRING);
    $shaderIncludes =     'test';
    ...
    //$lights =     filter_input(INPUT_POST, 'lights', FILTER_SANITIZE_STRING);
    $lights =     'test';
    ...
    //$skyboxTextures =     filter_input(INPUT_POST, 'skyboxTextures', FILTER_SANITIZE_STRING);
    $skyboxTextures =     'test';
